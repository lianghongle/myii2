    ...
    if ($gi->flags & GEOIP_SHARED_MEMORY) {
        ...
        for($i = 0; $i < STRUCTURE_INFO_MAX_SIZE; $i ++) {
            ...
            if ($delim == (chr ( 255 ) . chr ( 255 ) . chr ( 255 ))) {
                ...
                } else if (($gi->databaseType == GEOIP_CITY_EDITION_REV0) || ($gi->databaseType == GEOIP_CITY_EDITION_REV1) || ($gi->databaseType == GEOIP_ORG_EDITION) || ($gi->databaseType == GEOIP_ISP_EDITION) || ($gi->databaseType == GEOIP_ASNUM_EDITION)) {
...
function geoip_open($filename, $flags) {
    ...
    if ($gi->flags & GEOIP_SHARED_MEMORY) {
        ...
        $gi->filehandle = fopen ( dirname(__FILE__).'/'.$filename, "rb" ) or die ( "Can not open $filename\n" );
